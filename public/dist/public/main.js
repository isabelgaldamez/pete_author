...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<style>\n      table {\n    margin-top: 30px;\n    border: 1px solid black;\n    border-radius: 10px;\n  }\n  table th{\n    padding: 20px;\n    font-size: 20px;\n    border-right: 1px solid black;\n  }\n  table td{\n    padding: 20px;\n    font-size: 20px;\n    border-top: 1px solid black;\n    border-right: 1px solid black;\n  }\n  button{\n    /* height: 20px; */\n    font-size: 20px;\n    border-radius: 10px;\n  }\n  button:nth-child(2){\n    margin-left: 5px;\n  }\n</style>\n\n<a [routerLink]=\"['/new']\">Add an author</a>\n<h4>We have quotes by: </h4>\n<table>\n    <tr>\n        <th>Author</th>\n        <th>Actions available</th>\n    </tr>\n    <tr *ngFor = \"let author of allAuthors\" >\n        <td>{{author.name}}</td>\n        <td><button routerLink=\"/edit/{{author._id}}\">Edit</button><button (click) = 'deleteRecord(author._id)'>Delete</button></td>\n    </tr>\n</table>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<style>\n    .addAuthor{\n        padding: 10px;\n        border: 1px solid blue;\n        border-radius: 10px;\n    }\n    .addAuthor input{\n        margin-right: 2000px;\n    }\n    .cancel, .submit{\n        margin-top: 30px;\n        height: 40px;\n        /* width: 50px; */\n        font-size: 20px;\n        border-radius: 10px;\n        \n    }\n    .submit{\n        margin-left: 10px;\n        \n    }\n</style>\n\n<a [routerLink]=\"['/']\">Home</a>\n<h4>Edit the author: </h4>\n<div class='addAuthor'>\n    <form (submit) = 'editAuthor(editThisAuthor._id)' >\n        Name: <input type = 'text' name='name' [value] = 'editThisAuthor.name' [(ngModel)] = 'authorUpdate.name'>\n        <button [routerLink]=\"['/']\" class='cancel'>Cancel</button>\n        <button class='submit'>Submit</button>\n    </form>\n</div>");
...
module.exports = __webpack_require__(/*! /Users/isabelgaldamez/Documents/CodingDojo/Week7/ANGULAR/authors/public/src/main.ts */"./src/main.ts");
